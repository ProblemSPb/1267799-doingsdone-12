    ...
    <div class="container container--with-sidebar">
        ...
        <header class="main-header">
            ...
            <div class="main-header__side">
                <a class="main-header__side-item button button--transparent" href="login.php">Log in</a>
            </div>
        </header>
        ...
        <div class="content">
            ...
            <section class="content__side">
                <p class="content__side-info">Log in if you already have an account</p>

                <a class="button button--transparent content__side-button" href="login.php">Log in</a>
            </section>

            <main class="content__main">
                <h2 class="content__main-heading">Log in</h2>
                ...
                <form class="form" action="login.php" method="post" autocomplete="off">
                    <div class="form__row">
                        ...
                        <input class="form__input <?= isset($errors['email']) ? "form__input--error" : ""; ?>" type="text" name="email" id="email"
                               value="<?= getPOSTValue('email'); ?>" placeholder="Your e-mail">
                        <p class="form__message"><?= $errors['email'] ?? ""; ?></p>
                    </div>

                    <div class="form__row">
                        <label class="form__label" for="password">Password <sup>*</sup></label>
                        <input class="form__input <?= isset($errors['password']) ? "form__input--error" : ""; ?>" type="password" name="password" id="password" value=""
